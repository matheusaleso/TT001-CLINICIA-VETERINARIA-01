...
public class DisplayData {
    public static void displayClient(JTable table, int SelectedRow, HashMap<Integer, Integer> listObjects){
...
Object[] options1 = { "Deletar Cliente", "Atualizar Dados",
                "Fechar" };
        int result = JOptionPane.showOptionDialog(null, inputs, clientName.getText(),
...
if (result == 0) {
  ...
  public static void displayAnimal(JTable table, int SelectedRow, HashMap<Integer, Integer> listObjects){
      int rowIndex = (int)table.getSelectedRow();
...
Object[] options1 = { "Deletar Animal", "Atualizar Dados",
                "Fechar" };
        int result = JOptionPane.showOptionDialog(null, inputs, animalName.getText(),
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
                null, options1, null);
...
if (result == 0) {
 ...
 public static void displaySpecie(JTable table, int SelectedRow,HashMap<Integer, Integer> listObjects){
        int rowIndex = (int)table.getSelectedRow();
...
Object[] options1 = { "Deletar Espécie", "Atualizar Dados",
                "Fechar" };
        int result = JOptionPane.showOptionDialog(null, inputs, specieName.getText(),
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
                null, options1, null);
...
public static void displayVet(JTable table, int selectedRow,HashMap<Integer, Integer> listObjects){
        int rowIndex = (int)table.getSelectedRow();
...
Object[] options1 = { "Deletar Veterinário", "Atualizar Dados",
                "Fechar" };
        int result = JOptionPane.showOptionDialog(null, inputs, vetName.getText(),
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
                null, options1, null);
...
if (result == 0) {
    ...
    public static void displayAppointment(JTable table, int selectedRow,HashMap<Integer, Integer> listObjects) throws ParseException{
               int rowIndex = (int)table.getSelectedRow();
...
Object[] options1 = { "Deletar Consulta", "Atualizar Dados",
                "Fechar" };
        int result = JOptionPane.showOptionDialog(null, inputs, "Consulta",
                JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.PLAIN_MESSAGE,
                null, options1, null);
